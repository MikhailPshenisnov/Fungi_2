...
public class ArticleMediaStorageService : IArticleMediaStorageService
{
    private readonly ArticleMediaStorageOptions _options;
    private readonly string _rootPath;
    private readonly HashSet<string> _allowedExtensions;
    private readonly HashSet<string> _allowedMimeTypes;

    public ArticleMediaStorageService(IOptions<ArticleMediaStorageOptions> options, IWebHostEnvironment environment)
    {
    ...
    public async Task<string> SaveArticleImageAsync(IFormFile file, CancellationToken ct)
    {
        ...
        if (outputData is null)
            throw new IntegrityException("Unable to encode article image");
    ...
    public Task<bool> DeleteArticleImageAsync(string? mediaPath, CancellationToken ct)
    {
